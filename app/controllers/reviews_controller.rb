class ReviewsController < ApplicationController
  ...
  def index
    ...
    @reviews = @q.result(:distinct => true).includes(:recommendation, :user).page(params[:page]).per(10)
  end
  ...
  def current_user_must_be_review_user
    ...
    def review_params
      params.require(:review).permit(:user_id, :stars, :review_description, :movie_id)
    end
end
